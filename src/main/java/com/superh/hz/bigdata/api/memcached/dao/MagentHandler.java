...
/**
 * memcached代理，magent客户端测试
 * 2017-2-21
 */
public class MagentHandler {
	
	private static final Logger logger = LoggerFactory.getLogger(MagentHandler.class);
	...
	public static void initMemcachedSocketPool() {
		...
		/**
		 * 192.168.182.138:12000为magent服务，后台两个master memcached，两个slave memcached
		 * 命令为 ：
		 * ./magent -n 51200 -l 192.168.182.138 -p 12000 -s 192.168.182.137:11211 -s 192.168.182.139:11211 -b 192.168.182.138:11211 -b 192.168.182.140:11211
		 * 实验中存储5个key：master中137分配了2个，139分配了3个；slave中138分配了2个，140分配了3个。
		 * 
		 */
		stp.setServers(new String[]{"192.168.182.138:12000"});
